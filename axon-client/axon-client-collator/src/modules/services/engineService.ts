...
export default class EngineService {
    ...
    collatorSubmitTask = async (xfer: CollatorSubmitTaskTransformation,) => {
        ...
        for (let checkerInfo of xfer.inputCheckInfos) {
    ...
    collatorSubmitChallenge = async (xfer: CollatorSubmitChallengeTransformation,) => {
        ...
        for (let checkerInfo of xfer.inputCheckInfos) {
            if (checkerInfo.mode !== CheckerInfo.CHALLENGE_PASSED ||
        ...
        xfer.patternTypeWitness = new CollatorSubmitChallengeWitness(xfer.inputConfig.chainId, fee, feePerChecker, punishCheckerBitmap)
    ...
    refreshTask = async (xfer: CollatorRefreshTaskTransformation,) => {
        ...
        for (let task of xfer.inputTasks) {
            //full fill the code
