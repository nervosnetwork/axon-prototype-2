...
export class SidechainBond implements CellInputType, CellOutputType {
    ...
    constructor(capacity: bigint, sudtAmount: bigint, chainId: bigint, collatorPublicKeyHash: string, unlockSidechainHeight: bigint, outPoint: OutPoint) {
    ...
    static fromCell(cell: Cell): SidechainBond | null {
        ...
        let collatorPublicKeyHash = lockArgs.substring(2, 42)
        let unlockSidechainHeight = leHexToBigIntUint128(lockArgs.substring(42, 74))
    ...
    toCellOutput(): CKBComponents.CellOutput {
        let lock = SIDECHAIN_BOND_LOCK_SCRIPT
        lock.args = `0x${
            remove0xPrefix(Uint8BigIntToLeHex(this.chainId))}${
            remove0xPrefix(this.collatorPublicKeyHash)}${
    ...
    static fromJSON(source: Object): SidechainBond {
