...
export function SerializeGlobalConfigCell(value: object): ArrayBuffer;
export class GlobalConfigCell {
  constructor(reader: CanCastToArrayBuffer, options?: CreateOptions);
  validate(compatible?: boolean): void;
  static size(): number;
  getAdminLockArg(): PubKeyHash;
  getCheckerInfoCellTypeCodehash(): CodeHash;
  getCheckerInfoCellTypeHashtype(): HashType;
  getCheckerBondCellTypeCodehash(): CodeHash;
  getCheckerBondCellTypeHashtype(): HashType;
  getCodeCellTypeCodehash(): CodeHash;
  getCodeCellTypeHashtype(): HashType;
  getSidechainBondCellTypeCodehash(): CodeHash;
  getSidechainBondCellTypeHashtype(): HashType;
  getSidechainConfigCellTypeCodehash(): CodeHash;
  getSidechainConfigCellTypeHashtype(): HashType;
  getSidechainFeeCellTypeCodehash(): CodeHash;
  getSidechainFeeCellTypeHashtype(): HashType;
  getSidechainRegistryCellTypeCodehash(): CodeHash;
  getSidechainRegistryCellTypeHashtype(): HashType;
  getSidechainStateCellTypeCodehash(): CodeHash;
  getSidechainStateCellTypeHashtype(): HashType;
  getTaskCellTypeCodehash(): CodeHash;
  getTaskCellTypeHashtype(): HashType;
}
