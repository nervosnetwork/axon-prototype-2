...
export const CHECKER_BOND_LOCK_HASH_TYPE: HashType =
  process.env.CHECKER_BOND_LOCK_HASH_TYPE === "type" ? "type" : "data";
...
export const CHECKER_INFO_TYPE_HASH_TYPE: HashType =
  process.env.CHECKER_INFO_TYPE_HASH_TYPE === "type" ? "type" : "data";
...
export const SIDECHAIN_BOND_LOCK_HASH_TYPE: HashType =
  process.env.SIDECHAIN_BOND_LOCK_HASH_TYPE === "type" ? "type" : "data";
...
export const SIDECHAIN_CONFIG_TYPE_HASH_TYPE: HashType =
  process.env.SIDECHAIN_CONFIG_TYPE_HASH_TYPE === "type" ? "type" : "data";
...
export const SIDECHAIN_FEE_LOCK_HASH_TYPE: HashType =
  process.env.SIDECHAIN_FEE_LOCK_HASH_TYPE === "type" ? "type" : "data";
...
export const SIDECHAIN_STATE_TYPE_HASH_TYPE: HashType =
  process.env.SIDECHAIN_STATE_TYPE_HASH_TYPE === "type" ? "type" : "data";
