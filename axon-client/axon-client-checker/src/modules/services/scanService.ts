...
import {
    ...
    CODE_QUERY_OPTION, GLOBAL_CONFIG_QUERY_OPTION,
    ...
    SIDECHAIN_STATE_QUERY_OPTION, TASK_QUERY_OPTION,
...
export default class ScanService {
    ...
    public scanSidechainState = async (
        tip?: string,
    ): Promise<SidechainState> => {
    ...
    public scanSidechainConfig = async (
        tip?: string,
    ): Promise<SidechainConfig> => {
        const collector = new CellCollector(this.#knex, {
            toBlock: tip,
            ...SIDECHAIN_CONFIG_QUERY_OPTION,
            order: 'desc',
    ...
    public scanSidechainFee = async (
        tip?: string,
    ): Promise<SidechainFee> => {
        const collector = new CellCollector(this.#knex, {
            toBlock: tip,
            ...SIDECHAIN_FEE_QUERY_OPTION,
            order: 'desc',
    ...
    public scanSidechainBond = async (
        tip?: string,
    ): Promise<SidechainBond> => {
        const collector = new CellCollector(this.#knex, {
            toBlock: tip,
            ...SIDECHAIN_BOND_QUERY_OPTION,
            order: 'desc',
    ...
    public scanCheckerInfo = async (
        tip?: string,
    ): Promise<Array<CheckerInfo>> => {
        const collector = new CellCollector(this.#knex, {
            toBlock: tip,
            ...CHECKER_INFO_QUERY_OPTION,
            order: 'desc',
    ...
    public scanCheckerInfoSelf = async (
        tip?: string,
    ): Promise<CheckerInfo> => {
        const collector = new CellCollector(this.#knex, {
            toBlock: tip,
