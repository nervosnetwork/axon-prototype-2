...
#[derive(Clone)]
pub struct CommonSubmitJobsWitness(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for CommonSubmitJobsWitness {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for CommonSubmitJobsWitness {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for CommonSubmitJobsWitness {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::core::default::Default for CommonSubmitJobsWitness {
    fn default() -> Self {
        let v: Vec<u8> = vec![
        ...
        CommonSubmitJobsWitness::new_unchecked(v.into())
    }
}
impl CommonSubmitJobsWitness {
    ...
    pub fn as_reader<'r>(&'r self) -> CommonSubmitJobsWitnessReader<'r> {
        CommonSubmitJobsWitnessReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for CommonSubmitJobsWitness {
    type Builder = CommonSubmitJobsWitnessBuilder;

    const NAME: &'static str = "CommonSubmitJobsWitness";

    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        CommonSubmitJobsWitness(data)
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        CommonSubmitJobsWitnessReader::from_slice(slice).map(|reader| reader.to_entity())
    }

    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        CommonSubmitJobsWitnessReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
...
#[derive(Clone, Copy)]
pub struct CommonSubmitJobsWitnessReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for CommonSubmitJobsWitnessReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for CommonSubmitJobsWitnessReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for CommonSubmitJobsWitnessReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "chain_id", self.chain_id())?;
        write!(f, ", {}: {}", "commit", self.commit())?;
...
impl<'r> CommonSubmitJobsWitnessReader<'r> {
    pub const FIELD_COUNT: usize = 6;
...
impl<'r> molecule::prelude::Reader<'r> for CommonSubmitJobsWitnessReader<'r> {
    type Entity = CommonSubmitJobsWitness;

    const NAME: &'static str = "CommonSubmitJobsWitnessReader";
    ...
    fn new_unchecked(slice: &'r [u8]) -> Self {
        CommonSubmitJobsWitnessReader(slice)
    }
    ...
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        ...
        ExistedCommittedCheckerInfosReader::verify(&slice[offsets[1]..offsets[2]], compatible)?;
        RandomSeedReader::verify(&slice[offsets[2]..offsets[3]], compatible)?;
...
#[derive(Debug, Default)]
pub struct CommonSubmitJobsWitnessBuilder {
...
impl CommonSubmitJobsWitnessBuilder {
    pub const FIELD_COUNT: usize = 6;
...
impl molecule::prelude::Builder for CommonSubmitJobsWitnessBuilder {
    type Entity = CommonSubmitJobsWitness;

    const NAME: &'static str = "CommonSubmitJobsWitnessBuilder";
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        CommonSubmitJobsWitness::new_unchecked(inner.into())
    }
}
