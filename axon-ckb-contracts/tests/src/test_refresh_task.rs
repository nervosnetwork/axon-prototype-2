...
use common_raw::cell::sidechain_config::SidechainConfigCellData;
use common_raw::cell::task::TaskCellData;
...
fn test_success() {
    ...
    let task_cell_outpoint = builder.context.create_cell(output, task_cell_data.serialize());
